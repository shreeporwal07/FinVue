  ...
  return (
    <div className="p-5">
      ...
      <input
        ...
        className="w-full p-2 rounded bg-gray-800 text-white"
      />
      <button onClick={handleCalculateDebtPayoff} className="mt-3 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-700">Calculate Debt Payoff</button>
      {totalPaid !== null && (
        <p className="text-white mt-3">Total Paid after {debtDuration} months: ${totalPaid}</p>
      )}
    </div>
  );
}
