...
function DropdownProfile({
  ...
  return (
    <div className="relative inline-flex bg-gradient-to-r from-[#434974] to-[#242949] p-4 sm:p-6 rounded-lg overflow-hidden mb-8 h-80 w-1/4">
      <button
        ref={trigger}
      ...
      >
        <img className="w-20 h-20 rounded-full" src={UserAvatar} width="32" height="32" alt="User" />
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-2xl font-medium font-kalam dark:text-slate-300 group-hover:text-slate-200 m-4">Leena Shree</span>
