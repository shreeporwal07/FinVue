        ...
        <div className="flex h-screen overflow-hidden bg-[#181A2E]">
            ...
            <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
                ...
                <div className="m-10">
                    ...
                    <h3 className="font-inter mt-8 font-semibold">Your Progress</h3>
                    <div className="relative bg-gray-200 w-full h-3 rounded-3xl mb-8">
                        <div className="flex justify-center absolute top-0 left-0 h-full bg-green-500 rounded-3xl" style={{ width: `${Math.min(totalscore, 50)}%`, transition: 'width 1s ease-in-out' }}></div>
                    </div>
                            ...
                            <div key={module.id} className="flex py-5 px-5  flex-col gap-10 col-span-full xl:col-span-6 bg-gradient-to-r from-[#434974] to-[#242949] shadow-lg rounded-lg border border-slate-700">
                                <Link to={isAuthenticated ? module.path : ''} onClick={isAuthenticated ? undefined : loginWithRedirect}>
                                    <div className="flex justify-between ">
                                        <span className="text-2xl cursor-pointer font-inter">{module.title}</span>
