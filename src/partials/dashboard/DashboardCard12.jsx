...
function DashboardCard12() {
  return (
    <div className="col-span-full xl:col-span-6 bg-gradient-to-r from-[#434974] to-[#242949] shadow-lg rounded-lg border border-slate-700">
      ...
      <div className="p-3">
        ...
        {/* "Today" group */}
        <div>
          <header className="text-xs uppercase text-slate-500 bg-gradient-to-r from-[#434974] to-[#242949] rounded-lg font-semibold p-2">
            Today
          </header>
          <ul className="my-1">
            {/* Item */}
        ...
        {/* "Yesterday" group */}
        <div>
          <header className="text-xs uppercase text-slate-500 bg-gradient-to-r from-[#434974] to-[#242949] rounded-sm font-semibold p-2">
            Yesterday
          </header>
          <ul className="my-1">
            {/* Item */}
