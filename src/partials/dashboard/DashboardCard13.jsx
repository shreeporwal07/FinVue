  ...
  return (
    <div className="col-span-full xl:col-span-6 bg-gradient-to-r from-[#434974] to-[#242949] shadow-lg rounded-lg border border-slate-700">
      ...
      <div className="p-3">
        ...
        {/* "Today" group */}
        <div>
          <header className="text-xs uppercase text-slate-500 bg-opacity-50 rounded-sm font-semibold p-2">
            Today
          </header>
          <ul className="my-1">
            {/* Item */}
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-700 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center">
                    <a className="font-medium text-slate-100 dark:hover:text-white" href="#0">
                      Qonto
                    </a>{' '}
                    billing
                  </div>
